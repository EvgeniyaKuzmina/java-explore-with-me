...
/**
 * класс репозиторий для работы сс БД статистики
 */
public interface StatisticRepository extends JpaRepository<Statistic, Long> {

    /**
     * получение информации о просмотрах с уникальным ip с уточнением uris
     */
    ...
    /**
     * получение информации о просмотрах с уточнением uris
     */
