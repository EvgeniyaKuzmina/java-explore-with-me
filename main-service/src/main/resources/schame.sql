...
(
    ...
    --CONSTRAINT FK_EVENT_ON_COMPILATION FOREIGN KEY (event_id) REFERENCES events (id),
    --  CONSTRAINT FK_COMPILATION_ON_EVENT FOREIGN KEY (compilation_id) REFERENCES compilations (id)
...
(
    ...
    CONSTRAINT FK_EVENT_ON_COMPILATION_EVENT FOREIGN KEY (compilation_event_id) REFERENCES compilations_events (id)
);
...
(
    ...
    --event_id BIGINT                                  NOT NULL,
    pinned               BOOLEAN,
    compilation_event_id BIGINT                                  NOT NULL,
    CONSTRAINT pk_compilations PRIMARY KEY (id),
    CONSTRAINT UQ_COMPILATION_TITLE UNIQUE (title),
    CONSTRAINT FK_COMPILATION_ON_COMPILATION_EVENT FOREIGN KEY (compilation_event_id) REFERENCES compilations_events (id)
